  ...
  const teamMembers = [
    {
      name: "Sagar Gupta",
      role: "Team Member",
      image: "rickroll.jpg", // You'll need to add these images to your public folder
    ...
    },
    {
      ...
      role: "Team Member",
      image: "/Ash.jpg",
      description: "Experienced in backend development and system architecture."
    }
  ];
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <div className="flex justify-center space-x-4 mt-6">
                <a href="#" className="text-gray-400 hover:text-[#e8984a] transition-colors">
